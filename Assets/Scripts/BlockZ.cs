...
public class BlockZ : Blocks
{
    public override Vector3[] FindChildPos(Vector3 centerBlockPosition)
    {
        ...
        childPos[2] = new Vector3(centerBlockPosition.x, centerBlockPosition.y+1); // right child position
        childPos[3] = new Vector3(centerBlockPosition.x+1, centerBlockPosition.y-1); // upleft child position
